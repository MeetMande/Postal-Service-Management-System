...
// Navigation: Home, Parcels, Deliveries, Stamps, Find Us, Help, Info
// Profile accessible via username button top right.
...
namespace PostalServiceWinForms
{
    public class MainForm : Form
    {
        ...
        private void BuildNav()
        {
            ...
            pnlNav.Paint += (s, e) =>
            {
                using (var b = new System.Drawing.Drawing2D.LinearGradientBrush(
                    pnlNav.ClientRectangle, Color.FromArgb(160, 20, 20), Color.FromArgb(210, 55, 35), 0f))
                    e.Graphics.FillRectangle(b, pnlNav.ClientRectangle);
            };
            this.Controls.Add(pnlNav);

            // Logo
            pnlNav.Controls.Add(new Label { Text = "  PostalMS", Font = new Font("Segoe UI", 14, FontStyle.Bold), ForeColor = White, Location = new Point(18, 15), Size = new Size(150, 30), BackColor = Color.Transparent });

            // Nav buttons
            Button bHome = NB("Home", 175, ShowHome);
            Button bParc = NB("Parcels", 270, ShowParcels);
            Button bDeli = NB("Deliveries", 365, ShowDeliveries);
            Button bStamp = NB("Stamps", 470, ShowStamps);
            Button bFind = NB("Find Us", 560, ShowFindUs);
            Button bHelp = NB("Help", 650, ShowHelp);
            Button bInfo = NB("Info", 730, ShowInfo);
            SetActive(bHome);

            // AI Chat button
            Button btnAI = new Button { Text = "AI Chat", Location = new Point(820, 11), Size = new Size(90, 36), Font = new Font("Segoe UI", 9, FontStyle.Bold), BackColor = DarkRed, ForeColor = White, FlatStyle = FlatStyle.Flat, Cursor = Cursors.Hand };
            ...
            // Profile and Logout
            Button btnProf = new Button { Text = UserName.Split(' ')[0], Size = new Size(120, 36), Font = new Font("Segoe UI", 9), BackColor = DarkRed, ForeColor = White, FlatStyle = FlatStyle.Flat, Cursor = Cursors.Hand };
            ...
            Button btnOut = new Button { Text = "Logout", Size = new Size(85, 36), Font = new Font("Segoe UI", 9), BackColor = DarkRed, ForeColor = White, FlatStyle = FlatStyle.Flat, Cursor = Cursors.Hand };
            ...
            void Pos()
            {
                btnOut.Location = new Point(this.ClientSize.Width - 96, 11);
                btnProf.Location = new Point(this.ClientSize.Width - 226, 11);
            }
            Pos();
            this.Resize += (s, e) => Pos();
        ...
        {
            Button b = new Button { Text = text, Location = new Point(x, 0), Size = new Size(88, 58), Font = new Font("Segoe UI", 9), FlatStyle = FlatStyle.Flat, BackColor = Color.Transparent, ForeColor = Color.FromArgb(255, 200, 200), Cursor = Cursors.Hand };
